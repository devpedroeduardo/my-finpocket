...
import { useState, Suspense } from "react"; // <--- 1. Importamos o Suspense aqui
...
// 2. SEPARAMOS O CONTEÚDO EM UM COMPONENTE INTERNO (Sem o 'export default')
function LoginForm() {
...
// 3. A PÁGINA PRINCIPAL EXPORTADA QUE ENVOLVE TUDO NO SUSPENSE
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      <Suspense fallback={
        // Um esqueleto de carregamento sutil enquanto a URL é lida
        <div className="w-full max-w-md h-[400px] bg-white dark:bg-slate-900 rounded-xl animate-pulse shadow-sm" />
      }>
        <LoginForm />
      </Suspense>
    </div>
